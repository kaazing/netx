...
public final class WebSocketNativeConnectionStrategy extends WebSocketConnectionStrategySpi {
    private static final Collection<String> _supportedStrategies = unmodifiableList(asList("ws", "wss", "wsn", "wssn"));

    public WebSocketNativeConnectionStrategy() {
    }
    ...
    public WebSocketHandlerSpi createHandler(WsURLConnection conn) {
        return new WsURLConnectionHandlerNative(conn);
    }
}
