...
public abstract class DispatchChallengeHandler extends ChallengeHandler {
     ...
     *         with no user info or path specified.  </li>
     ...
     *     <li>{@code server.hostname.com:*}&#047;{@code *} -- matches all requests to a particular server on
     *         any port on any path but not the empty path. </li>
     * </ol>
