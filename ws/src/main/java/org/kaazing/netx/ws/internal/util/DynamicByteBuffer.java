...
/**
 * WrappedByteBuffer provides an automatically expanding byte buffer.
 */
public class DynamicByteBuffer {
    ...
    /**
     * The order property indicates the endian-ness of multi-byte integer types in the buffer.
    ...
    DynamicByteBuffer(byte[] bytes, int offset, int length) {
        this(java.nio.ByteBuffer.wrap(bytes, offset, length));
    }

    public DynamicByteBuffer(java.nio.ByteBuffer buf) {
        _buf = buf;
     ...
     */
    public final DynamicByteBuffer setAutoExpand(boolean autoExpand) {
    ...
    public static DynamicByteBuffer wrap(byte[] bytes) {
        return new DynamicByteBuffer(bytes);
    }
     ...
     * @return the bytes wrapped as a WrappedByteBuffer
     */
    public static DynamicByteBuffer wrap(byte[] bytes, int offset, int length) {
        return new DynamicByteBuffer(bytes, offset, length);
    }
     ...
     * @return the bytes wrapped as a WrappedByteBuffer
     */
    public static DynamicByteBuffer wrap(java.nio.ByteBuffer in) {
        return new DynamicByteBuffer(in);
    }
    ...
    public DynamicByteBuffer duplicate() {
        return DynamicByteBuffer.wrap(_buf.duplicate());
    }
     ...
     * @return the buffer
     */
    public DynamicByteBuffer fill(int size) {
        _autoExpand(size);
        while (size-- > 0) {
            _buf.put((byte) 0);
        }
     ...
     * @return the buffer
     */
    public DynamicByteBuffer fillWith(byte b, int size) {
        _autoExpand(size);
        while (size-- > 0) {
            _buf.put(b);
        }
     ...
     * @return the buffer
     */
    public DynamicByteBuffer put(byte[] v, int offset, int length) {
        _autoExpand(length);
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putAt(int index, byte v) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putUnsigned(int v) {
        byte b = (byte) (v & 0xFF);
        return this.put(b);
    }
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putUnsignedAt(int index, int v) {
        _checkForWriteAt(index, 1);
        byte b = (byte) (v & 0xFF);
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putShort(short v) {
        _autoExpand(2);
        _buf.putShort(v);
        return this;
    }
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putShortAt(int index, short v) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putUnsignedShort(int v) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putUnsignedShortAt(int index, int v) {
        _checkForWriteAt(index, 2);
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putIntAt(int index, int v) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putUnsignedInt(long value) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putUnsignedIntAt(int index, long value) {
        _checkForWriteAt(index, 4);
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putLongAt(int index, long v) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putString(String v, Charset cs) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putPrefixedString(int fieldSize, String v, Charset cs) {
        if (fieldSize == 0) {
            return this;
        }
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putBytes(byte[] b) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putBytesAt(int index, byte[] b) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putBuffer(DynamicByteBuffer v) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer putBufferAt(int index, DynamicByteBuffer v) {
    ...
    public long getUnsignedInt() {
        _checkForRead(4);
        long val = _buf.getInt() & 0xffffffffL;
        return val;
    }
    ...
    public long getUnsignedIntAt(int index) {
        _checkForReadAt(index, 4);
        long val = _buf.getInt(index) & 0xffffffffL;
        return val;
    }
    ...
    public DynamicByteBuffer slice() {
        return DynamicByteBuffer.wrap(_buf.slice());
    }
     ...
     */
    public DynamicByteBuffer position(int position) {
     ...
     * @return returns this buffer
     */
    public DynamicByteBuffer limit(int limit) {
     ...
     * @return the buffer
     */
    public DynamicByteBuffer skip(int size) {
        _autoExpand(size);
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof DynamicByteBuffer)) {
            return false;
        }
        DynamicByteBuffer that = (DynamicByteBuffer) obj;
     ...
     * @return the buffer
     */
    DynamicByteBuffer expand(int expectedRemaining) {
     ...
     * @return the buffer
     */
    DynamicByteBuffer expandAt(int i, int expectedRemaining) {
